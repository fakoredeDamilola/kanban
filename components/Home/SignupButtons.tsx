...
const Button = styled.button<{ field?: string }>`
  ...
  background-color: ${({ field }) =>
    field === "google" ? "#666BE1" : "#2A2B38"};
  border-radius: 6px;
  cursor: pointer;
  width: 80%;
  &:hover {
    background-color: ${({ field }) =>
      field === "googl" ? "#666BE1" : "#2A2B38"};
  }
        ...
        >
          ...
          <EmailInput>
            ...
            <CustomInput
              ...
              input="text"
              isError={
                errorTable.includes("password") ||
                (errorTable.includes("passLength") && true)
              }
              error={
                errorTable.includes("password")
                  ? "Please enter a password"
                  : errorTable.includes("passLength")
