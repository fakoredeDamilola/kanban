...
const CreateWorkspace = ({
  ...
  email,
  errorTableWorkspace,
  setErrorTableWorkspace,
  disableWorkspaceBtn,
  setDisableWorkspaceBtn,
  logOut,
}: {
  ...
  return (
    <Container>
      <EmailInfo>
        ...
        <SignedInBox onClick={logOut}>Log out</SignedInBox>
      </EmailInfo>
      ...
      <Wrapper>
        <MainText
          ...
          animate="visible"
        >
          <FontText>Create a new workspace</FontText>
          <FontParagraph>
        ...
        >
          <InputBoxName>
            ...
            <CustomInput
              ...
              error={
                errorTable.includes("workspaceName")
                  ? "Put enter a workspaceName"
                  : ""
              }
          ...
          <InputBox>
            ...
            <div>
              <CustomInput
                ...
                error={
                  errorTable.includes("workspaceURL")
                    ? "Put enter a workspaceURL"
                    : ""
                }
                setErrorTable={setErrorTable}
